...
function Watchmen() {
  ...
  return (
    <>
      <div>
        <Breadcrumbs className="pt-7 xl:pt-8 overflow-hidden w-full">
          <Link to={"/"}>Home</Link> &nbsp;
          <p className="text-red-500">Men's Watch</p>
        </Breadcrumbs>
      </div>
      <div
        data-aos="fade-right"
    ...
    container galaxy:justify-center galaxy:items-center overflow-hidden  iphone12:items-center  my-12  xl:flex-row sm:flex-row md:flex-col flex-col"
      >
        <div>
          <ProductFilter />
        </div>
