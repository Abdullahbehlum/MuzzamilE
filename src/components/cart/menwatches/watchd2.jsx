...
import Shoesimgdetails2 from "../../../assets/images/Cico.jpg"
import Shoesimgd2 from "../../../assets/images/31zvzQFJkDL.SX522_.jpg"
import Shoesimgdetails3 from "../../../assets/images/41nPv+J3CwL.SX522_.jpg"
...
const MenShoes = [
    {
      ...
      head: "Casio Men's Classic Dive Style Watch, 200 M WR, Screw Down Crown and Case Back, MDV106 Series",
      price: "$49.55",
      Aboutpara: "200 M Water Resistance",
      Aboutpara1: "Diver inspired Rotating bezel with anti reverse, Screw down crown",
      Aboutpara2: "Date display Regular timekeeping Analog: 3 hands (Hour, minute, second)",
      Aboutpara3: "Date display Regular timekeeping Analog: 3 hands (Hour, minute, second)",
      Aboutpara4: "Stainless Steel Case w/ Black Resin Band",
    },
  ];
function Watchd2() {
