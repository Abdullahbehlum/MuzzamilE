...
import Shoesimgdetails2 from "../../../assets/images/610VsCaFMXL._AC_SY535_.jpg";
import Shoesimgd2 from "../../../assets/images/81Rm+viI1zL._AC_SY675_.jpg";
import Shoesimgdetails3 from "../../../assets/images/81WefYmjWIS._AC_SY535_.jpg";
...
const MenShoes = [
  {
    ...
    price: "$17.95 - $49.99",
    Aboutpara:
      "Tennis bracelet featuring round 3mm AAAAA cubic zirconia stones in four-prong basket settings. Measures 6.5 inches in Length    ",
    Aboutpara1:
      "Cubic Zirconia set in Lead-free, Eco-friend and hypoallergenic setting. This stunning bracelet is then Gold Plated to ensure a long-lasting and brilliant finish.",
    Aboutpara2:
    ...
    Aboutpara3:
      " SUSTAINABILITY  PAVOI is dedicated to sustainability throughout our entire product cycle. Our jewelry is made from 100% recycled materials and we package in 99% recycled and compostable materials. We work to reduce our carbon emissions and offset plastic consumption by removing 275,000 bottles from oceans annually. We are committed to maintain a balanced and eco-friendly business that minimizes our environmental impact. Trust that PAVOI is continuously working towards a greener future.",
    Aboutpara4: "PROUDLY AMERICAN-OWNED",
  },
];
