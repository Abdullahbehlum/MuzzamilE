...
import Shoesimgdetails2 from "../../../assets/images/71ydDXQziTL._AC_SY695_.jpg";
import Shoesimgd2 from "../../../assets/images/71s8ql9E9yL._AC_SY695_.jpg";
import Shoesimgdetails3 from "../../../assets/images/710FeltQVlL._AC_SY695_.jpg";
...
const MenShoes = [
  {
    ...
    head: "Leafael Valentine's Day Gift Necklaces for Women, Infinity Love Heart Pendant with Birthstone Crystals, Silver Plated 18 + 2 inch Chain, Jewelry Birthday Gifts for Wife, Girlfriend, Mom, & Her",
    price: "$39.99",
    Aboutpara:
      "Heart Necklaces with Birthstone Crystals - Our Infinity Love heart necklace for women is an original design from our studio in Boston and features a precious Austrian birthstone crystal. This classic yet innovative deisgn takes you across dimensions of time and space, the prosperity of life, and ultimately the triumph of love. It's a perfect gift for women and girls!",
    Aboutpara1:
      "Delicate Fashion Jewelry Gift that Fits - This woman’s necklace is adorned with a 0.75 x 0.88-inch turquoise aquamarine blue birthstone crystal for December. They are rhodium plated and designed with an 18-inch chain plus 2-inch extender, and a lobster claw clasp.",
    Aboutpara2:
      "Strict Safety Standards - These birthstone charms and love gifts meet rigid safety standards. Our jewelry collections pass European 1907/2006 REACH Regulation Annex XVII Item 23,27, and 63, and are lead free, nickel free, and allergy free.All of our jewelry products are polished by hand.",
    Aboutpara3:
      "Crystal Necklace for Ladies Like You - Honor your inner royalty with this unique crystal heart pendant necklace. Presented by Miss New York - Nicole Kulovany, this heart necklace is a regal, symbolic statement piece that unveils your feminine spirit.",
    Aboutpara4:
      "Thoughtful Gifts for Women and Girls - Looking for exceptional Mother’s Day, birthday, anniversary, holiday, and Valentine’s Day gifts for your wife, mom, sister, daughter, or girlfriend? Each Leafael necklace is stored in an elegant white, silver-embossed gift box and gift bag, making it an ideal ladies necklace for the special women or girl in your life.",
  },
];
