...
import Shoesimgdetails2 from "../../../assets/images/71zubto6KsL._AC_SY550_.jpg"
import Shoesimgd2 from "../../../assets/images/91ihxpW4HjL._AC_SY550_.jpg"
import Shoesimgdetails3 from "../../../assets/images/81aTNFGnvyL._AC_SY550_.jpg"
...
const MenShoes = [
    {
      ...
      head: "ZESICA Women's 2024 Fall Fashion Turtleneck Long Sleeve Striped Ribbed Knit Loose Pullover Sweater Tops",
      price: "$46.99 - $47.99",
      Aboutpara: "Size Guide: S=US 4-6, M=US 8-10, L=US 12-14, XL=US 16-18. Mid-high elasiticity sweater, please check the size chart before purchase!",
      Aboutpara1: "This trendy knit pullover features drop batwing sleeves, chic mock neck, classic striped/plaid pattern, soft knitted with ribbed cuffs, loose silhouette fit for almost all the body shapes! Create your new early spring or autumn/winter fashion look!",
      Aboutpara2: "Made of soft, warm and breathable fabric, ultra skin friendly and not itchy. You will want to wear this turtleneck jumper top frequently during the fall and winter months.",
      Aboutpara3: "Pretty and versatile. This long sleeve striped sweater is perfect to dress up or down. You can wear with leggings, jeans or pencil skirts, also goes well with coat, jacket and blazer. Suitable for casual, daily, school, office, party, church, picnic, date, family gathering, etc.",
      Aboutpara4: "Garment Care: Machine wash with laundry bag recommended, hand washable in cold, do not bleach, iron in low, hang or line dry.",
    },
  ];
function womend6() {
