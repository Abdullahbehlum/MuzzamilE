...
import Arrivalimg from "../../../assets/images/61BhBgTdnbL._AC_SY550_.jpg"
import Arrivalimg1 from "../../../assets/images/51fhZ3veYpL._AC_SY550_.jpg"
import Arrivalimg2 from "../../../assets/images/61Wu1yX+fFL._AC_SY741_.jpg"
import ReactImageGallery from "react-image-gallery";
const MenShoes = [{

    images: [{
        original: Arrivalimg,
        thumbnail: Arrivalimg
    }, {
        original: Arrivalimg1,
        thumbnail: Arrivalimg1,
    }, {
        original: Arrivalimg2,
        thumbnail: Arrivalimg2
    }],

    head: "Legendary Whitetails Men's Buck Camp Flannel, Long Sleeve Plaid Button Down Casual Shirt, Corduroy Cuffs",
    price: "$36.99 - $38.99",
    Abouthead: "Material: Made of 50% polyester 50% cotton,these materials are thick and comfortable,keep you warm in the fall and winter.",
    Aboutpara: "Design: Oversized hoodie,pullover sweatshirts,drop shoulder collar,long sleeve sweater with pocket,fall outfits for women,winter fashion clothes,aesthetic clothing,y2k fleece casual style",
    Aboutpara1: "Match: This fall fashion hoodies is fhe ideal choice in your wardrobe,one of the best choice for autumn and winter outfits.easy to match with pants,jeans,joggers,sweatpants,and you can match anything you like inside,like underscrub shirts,tank top,crop top, vest etc",
    Aboutpara2: "Occasion: This pullover sweatshirt is suitable for casual,office,party,school,running,sport,gym,dancing,skating,hiking,biking,yogo,spring,fall and winter.",
    Aboutpara3: "Machine washable, hand washes cold water. Do not bleach."
}
]
