...
import Shoesimgdetails2 from "../../../assets/images/71pYTpZ0bFL._AC_SY535_.jpg";
import Shoesimgd2 from "../../../assets/images/71BTybalOzL._AC_SY695_.jpg";
import Shoesimgdetails3 from "../../../assets/images/81XyKiw89zL._AC_SY695_.jpg";
...
const MenShoes = [
  {
    ...
    head: "Montana West 3PCS Purses for Women Tote Purse and Wallet Set Shoulder Satchel Bags",
    price: " $39.99",
    Aboutpara:
      "Montana West Classic Handbags, where style meets sophistication in the most exquisite way.",
    Aboutpara1:
      "[Multi-function] These womens purses come with upgrade hardware and durable zipper, suitable for a long time. Moreover,the purse sets goes well with any clothes in any occasions such as dating, traveling,working, shopping. Also the purse and wallet set can be a excellent gift for birthday, Valentine's Day, Anniversary, Christmas, Mother's Day and every important or special day for her.",
    Aboutpara2:
      "[Superb Material] This womens tote purse made of PU leather. The stitching is well made as smoothly to touch. The linging of this tote bag purse was used the supreme cloth. There's no chemical left in this women's purse. 3pcs in 1 set, it is convenient for you.",
    Aboutpara3:
      "[Exquisite Detail] The elegant design of this leather purses and handbags can match your clothing style. Golden buckle make the handbag safety. Also leather handbags for women comes with a adjustable and removable shoulder strap. Not only can use it as handbag, but also can make it a shoulder purses for women.",
    Aboutpara4:
      "[After-Sale Service] Montana West always committed to provide customers quality products and good after-sale service. We provide a 90 days warranty for all products we sell and offer you a timely solution within 24 hours once get your email.",
  },
];

function Womenebagd1() {
