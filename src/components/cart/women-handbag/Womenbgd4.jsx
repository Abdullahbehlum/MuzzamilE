...
import Shoesimgdetails2 from "../../../assets/images/61SD1H-7uML._AC_SX535_.jpg";
import Shoesimgd2 from "../../../assets/images/71-nFQnCWbL._AC_SY535_.jpg";
import Shoesimgdetails3 from "../../../assets/images/71q+9mRvpaL._AC_SY535_.jpg";
...
const MenShoes = [
  {
    ...
    head: "Bagsure Handbag Set, Purse Sets for Women, Tote Bag 4 pcs, Fashion Purse Sets Women's Handbags The Tote Bag Handbags Sets",
    price: "$32.99",
    Aboutpara:
      "👜【HIGH QUALITY MATERIAL】This purse and wallet set for women is made of high quality synthetic leather with durable gold hardware. Detailed stitching with smoothly zippers. Highly anti-scratch and tear-resistant, it does not easy to be out of shape.",
    Aboutpara1:
      "👜【MULTI-FUNCTION】This women's purse has a large capacity and can hold many items. A practical and stylish handbag can be used in different scenarios such as work, shopping, outdoors, etc. Also, the purse can be an excellent gift for a birthday, Valentine's Day, Anniversary, Christmas, Mother's Day gift, and every essential or special day for her.",
    Aboutpara2:
      "👜【FASHION DESIGN】The purses and wallets set for women can be used as a stylish pieces to complement your outfit. The satchel wallet can be carried by hand or used as a crossbody bag with a cross-body strap. The delicate metal buttons and zipper pulls are very fashionable accessories.",
    Aboutpara3:
      "👜【EXQUISITE DETAIL】Top zipper closure women's purse detailed with high-quality gold-tone hardware, zippers, and flat bottom studs with multiple colors looks more fashionable. Decorated with a top handle can be used as a daily purse, shoulder bag, or mothers Day gift.",
    Aboutpara4:
      "👜【AFTER-SALE SERVICE】Bagsure is always committed to providing customers with quality products and good after-sale service. We provide a 90 days warranty for all products and a timely solution （free return and exchange services, etc.） within 24 hours once we get your email.    ",
  },
];

function Womenebagd4() {
