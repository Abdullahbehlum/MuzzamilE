...
import Shoesimgdetails2 from "../../../assets/images/61T30XN3EgL._AC_SX535_.jpg";
import Shoesimgd2 from "../../../assets/images/61QCMvMD6-L._AC_SY695_.jpg";
import Shoesimgdetails3 from "../../../assets/images/61QCMvMD6-L._AC_SY695_.jpg";
...
const MenShoes = [
  {
    ...
    head: "adidas Men's Park Street Sneaker",
    price: "$40.99 - $69.99",
    Aboutpara: "Men's casual shoes for all-day comfort",
    Aboutpara1: "LIGHTWEIGHT COMFORT: Synthetic leather upper for durability and light weight",
    Aboutpara2: "TWO-LAYER SOCKLINER: Cloudfoam Comfort sockliner is ultra-soft and plush, with two layers of cushioning topped with soft, breathable mesh",
    Aboutpara3: "RUBBER OUTSOLE: The non-marking rubber outsole provides outstanding grip and a sleek, low-profile look    ",
    Aboutpara4: "MADE IN PART WITH RECYCLED CONTENT: Made with a series of recycled materials, this upper features at least 50% recycled content. This product represents just one of our solutions to help end plastic waste",
  },
];
function menShoesD2() {
  const { id } = useParams();
