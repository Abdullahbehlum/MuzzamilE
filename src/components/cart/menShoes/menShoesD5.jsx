...
// 717eiBjkp6L._AC_SY695_.jpg
import Shoesimgdetails2 from "../../../assets/images/81Nv7Y4sDEL._AC_SX695_.jpg"
import Shoesimgd2 from "../../../assets/images/717eiBjkp6L._AC_SY695_.jpg"
import Shoesimgdetails3 from "../../../assets/images/61doMvLvm0L._AC_SY695_.jpg"
...
const MenShoes = [
  {
    ...
    head: "adidas Originals Swift Run 22 Mens Shoes",
    price: "$70.95",
    Aboutpara: "Made in the USA or Imported",
    Aboutpara1: "Ethylene Vinyl Acetate sole",
    Aboutpara2: "Shaft measures approximately low-top from arch",
    Aboutpara3: " Regular Fit. The Swiftrun Shoe RUNS LARGE. We recommend sizing down",
    Aboutpara4: "Lightweight EVA midsole; Enjoy the comfort and performance of OrthoLite sockliner",
  },
];
function MenShoesD5() {
    const { id } = useParams();
