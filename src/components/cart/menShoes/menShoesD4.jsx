...
import Shoesimgdetails2 from "../../../assets/images/81AgEU43L-L._AC_SX675_.jpg";
import Shoesimgd2 from "../../../assets/images/81BMMyQNj1L._AC_SX535_.jpg";
import Shoesimgdetails3 from "../../../assets/images/81AFFLJSn8L._AC_SX535_.jpg";
...
const MenShoes = [
  {
    ...
    head: "Skechers Men's Energy Afterburn",
    price: "$38.70 - $75.00",
    Aboutpara: "Lace-up",
    Aboutpara1: "Shock-absorbing supportive midsole",
    Aboutpara2: "Flexible rubber traction outsole",
    Aboutpara3: "Cushioned comfort insole ",
    Aboutpara4: "11/2 inch heel",
  },
];
function MenShoesD4() {
  const { id } = useParams();
