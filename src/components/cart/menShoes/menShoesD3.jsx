...
import Shoesimgdetails2 from"../../../assets/images/813UuOjWfZL._AC_SX535_.jpg"
import Shoesimgd2 from"../../../assets/images/71UFOV3lrZL._AC_SY625_.jpg"
import Shoesimgdetails3 from"../../../assets/images/71n6mPfWttL._AC_SY695_.jpg"
...
const MenShoes = [
    {
      ...
      head: "Steve Madden Men's Fenta Fashion Sneaker",
      price: "$39.00",
      Aboutpara: "No Heel      ",
      Aboutpara1: "Textile upper and lining",
      Aboutpara2: "TWO-LAYER SOCKLINER: Cloudfoam Comfort sockliner is ultra-soft and plush, with two layers of cushioning topped with soft, breathable mesh",   Aboutpara3: "Lace-up closure    ",
      Aboutpara4: "Round toe  ",
  }];
function MenShoesD3() {
    const { id } = useParams();
    // console.log(id);
