...
import Pdthree1 from "../../../assets/images/91yuQ3m+cvL._AC_SX679_.jpg"
import Pdthree2 from "../../../assets/images/91oVJC4DNiL._AC_SY879_.jpg"
import Pdthree3 from "../../../assets/images/9149phA07hL._AC_SX679_.jpg"
          ...
          <>
            <div className="lg:w-4/5 flex  flex-col xl:flex-row justify-center items-center md:flex-row sm:flex-row">
              <div className="desktop-hide">
                <ReactImageGallery
                  items={ProductDetailThree.images}
            ...
            <div className="my-12 xl:mx-12 mx-5  text-black">
              <h1>Description</h1>
               <p className="my-3 xl:w-4/6 w-full xl:text-sm text-xs">
                {ProductDetailThree.Aboutpara}
              </p>
               <p className="my-3 xl:w-4/6 w-full xl:text-sm text-xs">
                {ProductDetailThree.Aboutpara1}
              </p>
               <p className="my-3 xl:w-4/6 w-full xl:text-sm text-xs">
                {ProductDetailThree.Aboutpara2}
              </p>
               <p className="my-3 xl:w-4/6 w-full xl:text-sm text-xs">
                {ProductDetailThree.Aboutpara3}
              </p>
