  ...
  return (
    <>
      ...
      <div className="flex flex-col justify-center items-center overflow-hidden iphone12:overflow-hidden">
        <div>
          <h1 className="head text-center xl:mb-8 mb-3"> Terms of Service</h1>
          <div className="flex justify-center text-slate-700 items-center flex-col overflow-hidden ">
            ...
            <p className="xl:text-sm text-xs text-balance xl:w-1/2 w-4/5 xl:mb-8 mb-3">
              This website is operated by Kurta Designer. Throughout the site,
              the terms “we”, “us” and “our” refer to Kurta Designer. Kurta
              Designer offers this website, including all information, tools,
            ...
            <p className="xl:text-sm text-xs text-balance xl:w-1/2 w-4/5 xl:mb-8 mb-3">
              Any new features or tools that are added to the current store
            ...
            <h4 className="xl:mb-8 mb-3 text-black right-[4em] xl:text-sm text-xs relative xl:right-[14.4em]  font-extrabold">
            ...
            <h4 className="xl:mb-8 mb-3 overflow-hidden text-black xl:text-sm right-[4em] relative xl:right-[14.4em] text-xs font-extrabold">
            ...
            <h4 className="xl:mb-8 mb-3  px-8 xl:px-0 right-[0.1em] text-black relative xl:right-[4.4em] xl:text-sm text-xs font-extrabold">
            ...
            <h4 className="xl:mb-8 mb-3 xl:relative xl:right-[9.4em] text-black xl:text-sm text-xs font-extrabold">
            ...
            <h4 className="xl:mb-8  overflow-hidden xl:relative xl:right-[10.4em] mb-3 text-black xl:text-sm text-xs font-extrabold">
            ...
            <p className="xl:text-sm text-xs text-balance xl:w-1/2 w-4/5 xl:mb-8 mb-3">
              ...
              sole discretion us. We reserve the right to discontinue any
            ...
            <h4 className="xl:mb-8 mb-3 xl:relative xl:right-[4.9em] px-6 xl:px-0 text-black xl:text-sm text-xs font-extrabold ">
              Kurta Designer this website and brand, IS NOT AFFILIATED,
              SPONSORED, OR <br className="mb-hide" /> PARTNERED WITH ANY BRAND
              DISPLAYED AND SOLD ON THIS SITE IN ANY <br className="mb-hide" />{" "}
              WAY.
            </h4>
            <h4 className="xl:mb-8 mb-3 px-12 xl:px-0 relative right-[1em] xl:right-[7em]  text-black xl:text-sm text-xs  font-extrabold text-balance">
            ...
            <h4 className="xl:mb-8 mb-3 xl:relative xl:right-[10.4em]  text-black xl:text-sm text-xs  font-extrabold text-balance">
              For more detail, please review our Returns Policy.
            </h4>
            <h4 className="xl:mb-8 mb-3 relative right-[5em] xl:right-[15.4em]  text-black xl:text-sm text-xs  font-extrabold text-balance">
            ...
            <h4 className="xl:mb-8 mb-3 relative right-[4em] xl:right-[15.4em]  text-black xl:text-sm text-xs  font-extrabold text-balance">
            ...
            <h4 className="xl:mb-8 mb-3 relative right-[0.2em]  xl:right-[11.4em]  text-black xl:text-sm text-xs  font-extrabold text-balance">
              SECTION 9 - USER COMMENTS, FEEDBACK AND <br /> OTHER SUBMISSIONS
            </h4>{" "}
            <p className="xl:text-sm text-xs text-balance xl:w-1/2 w-4/5 xl:mb-8 mb-3">
            ...
            <h4 className="xl:mb-8 mb-3 xl:relative xl:right-[13.4em]  text-black xl:text-sm text-xs  font-extrabold text-balance">
            ...
            <p className="xl:text-sm text-xs text-balance xl:w-1/2 w-4/5 xl:mb-8 mb-3">
              ...
              law. No specified update or refresh date applied in the Service or
              on any related website should be taken to indicate that all
              information in the Service or on any related website has been
              modified or updated.
            </p>
            <h4 className="xl:mb-8 mb-3 relative xl:right-[15.4em] right-[4em] text-black xl:text-sm text-xs  font-extrabold text-balance">
            ...
            <h4 className="xl:mb-8 mb-3 xl:relative xl:right-[7.4em] px-9 xl:px-0  text-black xl:text-sm text-xs  font-extrabold text-balance">
            ...
            <p className="xl:text-sm text-xs text-balance xl:w-1/2 w-4/5 xl:mb-8 mb-3">
              In no case shall Kurta Designer, our directors, officers,
              ...
              extent permitted by law. ﻿Kurta Designer is not responsible for
              any injury, loss, death, damage, or any similar damage caused by
              the use of our products. The buyer is fully responsible and aware
              for any type of damage, harm, or injury caused by Kurta Designer
              products.
            </p>
            <h4 className="xl:mb-8 mb-3 right-[4em] relative xl:right-[15.4em]  text-black xl:text-sm text-xs  font-extrabold text-balance">
              SECTION 14 - INDEMNIFICATION{" "}
            </h4>{" "}
            <p className="xl:text-sm text-xs text-balance xl:w-1/2 w-4/5 xl:mb-8 mb-3">
              You agree to indemnify, defend and hold harmless Kurta Designer
            ...
            <h4 className="xl:mb-8 mb-3 xl:relative xl:right-[15.4em]  text-black xl:text-sm text-xs  font-extrabold text-balance">
            ...
            <h4 className="xl:mb-8 mb-3 relative right-[4em] xl:right-[11.4em]  text-black xl:text-sm text-xs  font-extrabold text-balance">
            ...
            <h4 className="xl:mb-8 mb-3 relative  right-[4em] xl:right-[13.4em]  text-black xl:text-sm text-xs  font-extrabold text-balance">
              SECTION 20 - CONTACT INFORMATION
            </h4>{" "}
            <p className="xl:text-sm text-xs text-balance xl:w-1/2 w-4/5  mb-3">
              Questions about the Terms of Service should be sent to us
            </p>
            <p className="xl:text-sm text-xs text-balance xl:w-1/2 w-4/5 xl:mb-8 mb-3">
              at Abc332@example.com
            </p>
          </div>
        </div>
      </div>
